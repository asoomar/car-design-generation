...
# TODO add rohan/ali dcgan models
from image_generation.car_dcgan import model_def as car_dcgan_model_def
...
def dcgan_discrim(x_hat_batch, hparams):
    ...
    prob, _ = car_dcgan_model_def.discriminator(model_hparams, discrim_input, train=False, reuse=False)
