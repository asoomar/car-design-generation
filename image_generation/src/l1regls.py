"""L1 regularized regression with CVXOPT.
This file is from : http://cvxopt.org/_downloads/l1regls.py
It comes with the following license: https://github.com/cvxopt/cvxopt/blob/master/LICENSE
"""
# pylint: skip-file
